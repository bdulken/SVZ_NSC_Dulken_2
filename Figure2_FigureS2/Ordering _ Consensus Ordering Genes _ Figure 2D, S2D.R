...
table_50<-table_1[table_1>50]
#Writing consensus ordering genes
write.table(names(table_50),"/Volumes/guacamole/Software/Final Scripts for Paper _ 01152015/Files/10282015_names_in50models_3.txt")
...
#curated_ordering_genes<-as.vector(read.table("/Volumes/guacamole/Software/Final Scripts for Paper _ 01152015/Files/10282015_names_in50models_2.txt")[,1])
curated_ordering_genes<-names(table_50)
...
pdf("spanningtree_looped_original_4groups_all_based_table50.pdf",onefile=T)
...
pdf("Id3_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Rpl32_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Cdk4_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Cdk1_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Dlx2_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Dcx_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Egfr_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Ascl1_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Pax6_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Olig2_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Notch2_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Nrxn3_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Dlx6as1_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Sp8_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Sp9_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Ccna2_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Ccnd2_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Atp1a2_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Gja1_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Tpx2_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Fgfr3_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Lgr4_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Jag1_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Ntsr2_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Dlx1_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Aldoc_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Slc1a3_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
my_genes_ind <- match(my_genes,row.names(subset(fData(HSMM_q))))
cds_subset <- HSMM_q[my_genes_ind, ]
pdf("Prc1_aggregated_ordering_top100_Figure2.pdf",height=1.5,width=5)
p<-plot_genes_in_pseudotime_mod(cds_subset,color_by="type",cell_size=2,color_custom=c("#ff3333","#00CCFF","#9966FF"),trend_formula=NULL)
p<-p+theme(axis.line=element_blank())
p<-p+theme(axis.title.y=element_blank())
p<-p+theme(axis.title.x=element_blank())
...
#  group1<-rownames(pData(HSMM_q)[pData(HSMM_q)[,2]<=25,])
#  group2<-rownames(pData(HSMM_q)[pData(HSMM_q)[,2]>=25&pData(HSMM_q)[,2]<46,])
#  group3<-rownames(pData(HSMM_q)[pData(HSMM_q)[,2]>=46&pData(HSMM_q)[,2]<64,])
#  group4<-rownames(pData(HSMM_q)[pData(HSMM_q)[,2]>=64&pData(HSMM_q)[,2]<78,])
#  group5<-rownames(pData(HSMM_q)[pData(HSMM_q)[,2]>=78,])
#  write.table(group1,"group1_10282015_50minModels_quiescent1_consensus_2.txt")
#  write.table(group2,"group2_10282015_50minModels_active_nondividing_consensus_2.txt")
#  write.table(group3,"group3_10282015_50minModels_active_dividing_early_consensus_2.txt")
#  write.table(group4,"group4_10282015_50minModels_active_dividing_late_consensus_2.txt")
#  write.table(group5,"group5_10282015_50minModels_active_dividing_consensus_2.txt")
#  
